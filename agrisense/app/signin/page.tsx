    ...
    <div className="flex flex-col items-center justify-center min-h-[calc(100vh-200px)] w-full">
      <div className="bg-[#FDFAF4] border-[0.5px] border-[#D9CEB8] rounded-[16px] p-10 w-[90%] max-w-[400px] flex flex-col gap-6 shadow-sm">
        ...
        <div className="flex flex-col gap-4 mt-2">
          ...
          <button onClick={handleSignIn} type="button" className="border-[0.5px] border-[#D9CEB8] text-[#2C2416] w-full py-[12px] rounded-[24px] font-medium text-[13px] flex items-center justify-center gap-2 hover:bg-[#F5F1EA] transition-colors">
